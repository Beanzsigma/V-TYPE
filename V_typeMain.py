...
def control(canvas, canvas_img):
    ...
    canvas.tag_bind(typecode, "<Enter>", lambda e: [canvas.itemconfig(typecode, fill="#577891"), canvas.itemconfig(typecode2, fill="#577891")])
    canvas.tag_bind(typecode, "<Leave>", lambda e: [canvas.itemconfig(typecode, fill="white"), canvas.itemconfig(typecode2, fill="white")])
    canvas.tag_bind(typecode2, "<Button-1>", lambda e: starttyping(textarea, buttoncheck, canvas, speedslider, pausebutton))
    canvas.tag_bind(typecode2, "<Enter>", lambda e: [canvas.itemconfig(typecode2, fill="#577891"), canvas.itemconfig(typecode, fill="#577891")])
    canvas.tag_bind(typecode2, "<Leave>", lambda e: [canvas.itemconfig(typecode2, fill="white"), canvas.itemconfig(typecode, fill="white")])
